...
icon = ttk.PhotoImage(file='icons/png-cheat-engine.png')
...
image_icon = ttk.PhotoImage(file='icons/add_image.png').subsample(12, 12)
flip_icon = ttk.PhotoImage(file='icons/flip_photo.png').subsample(12, 12)
rotate_icon = ttk.PhotoImage(file='icons/rotate_photo.png').subsample(12, 12)
color_icon = ttk.PhotoImage(file='icons/pick_color.png').subsample(12, 12)
erase_icon = ttk.PhotoImage(file='icons/erase.png').subsample(12, 12)
save_icon = ttk.PhotoImage(file='icons/save.png').subsample(12, 12)

# button for adding/opening the image file
image_button = ttk.Button(left_frame, image=image_icon, command=open_image)
image_button.pack(pady=5)
# button for flipping the image file
flip_button = ttk.Button(left_frame, image=flip_icon, command=flip_image)
flip_button.pack(pady=5)
# button for rotating the image file
rotate_button = ttk.Button(left_frame, image=rotate_icon, command=rotate_image)
rotate_button.pack(pady=5)
# button for choosing pen color
color_button = ttk.Button(left_frame, image=color_icon, command=change_color)
color_button.pack(pady=5)
# button for erasing the lines drawn over the image file
erase_button = ttk.Button(left_frame, image=erase_icon, command=erase_lines)
erase_button.pack(pady=5)
# button for saving the image file
save_button = ttk.Button(left_frame, image=save_icon, command=save_image)
